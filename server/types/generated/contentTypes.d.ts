...
export interface ApiBannerBanner extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Media_zone: Schema.Attribute.DynamicZone<
      ['common.video-banner', 'common.image-banner']
    >;
    publishedAt: Schema.Attribute.DateTime;
    Title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiContactContact extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Contact_image: Schema.Attribute.Media<'images' | 'files'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProductVariantProductVariant
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Materials: Schema.Attribute.Enumeration<
      [
        'Cotton',
        'Polyester',
        'Leather',
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Description: Schema.Attribute.Text;
    isRelevant: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
